...
public class CacheHost implements Serializable,IFluchCache,IJsonOuter {
	/**
	 * 
	 */
	...
	public static CacheHost[] getAll(){
		return cacheMap.values().toArray(new CacheHost[] {});
	}
	...
	public String toJSONString() {
		...
		json.push("key", this.key);
		json.push("value", this.obj);
